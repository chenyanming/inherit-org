...
For Text modes, fundemental mode, you can just insert */+/- as start just like org mode."
  (interactive)
  (font-lock-mode)
  (let ((h1 (concat comment-start-skip "[ ]\\* .*"))
        (h2 (concat comment-start-skip "[ ]\\*\\* .*"))
        (h3 (concat comment-start-skip "[ ]\\*\\*\\* .*"))
        (h4 (concat comment-start-skip "[ ]\\*\\*\\*\\* .*"))
        (h5 (concat comment-start-skip "[ ]\\*\\*\\*\\*\\* .*"))
        (h6 (concat comment-start-skip "[ ]\\*\\*\\*\\*\\*\\* .*"))
        (h7 (concat comment-start-skip "[ ]\\*\\*\\*\\*\\*\\*\\* .*"))
        (h8 (concat comment-start-skip "[ ]\\*\\*\\*\\*\\*\\*\\*\\* .*"))
        (plus (concat comment-start-skip "[ ]\\+ .*"))
        (minus (concat comment-start-skip "[ ]\\- .*")))
